...
final class Init
{
    ...
    public function __construct(LoaderInterface $loader, array $filters)
    {
        ...
        if (static::$didInit) {
            throw new \Exception(esc_html__('Init has been performed.', 'qibla-woocommerce-listings'));
        }
    ...
    {
        trigger_error(esc_html__('Cheatin&#8217; huh?', 'qibla-woocommerce-listings'), E_USER_ERROR);
    }
