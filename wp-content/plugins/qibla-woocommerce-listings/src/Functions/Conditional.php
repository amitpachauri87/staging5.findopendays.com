 ...
 * Conditional
 *
 * @author     guido <dev@guidoscialfa.com>
...
/**
 * If Single Listings has product
 *
 * @since 1.0.0
 *
 * @return bool True if the product is showing, false otherwise.
 */
function singleListingsHasProduct()
{
}
