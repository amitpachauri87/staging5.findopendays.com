...
return apply_filters('qibla_listings_form_button_fields', array(
    ...
    'qibla_listing_form-meta-button_text:text'   => $fieldFactory->base(array(
        ...
        'label'               => esc_html__('Button text', 'qibla-listings'),
        'container_class'     => array('dl-field', 'dl-field--text', 'dl-field--in-column'),
        'invalid_description' => esc_html__('Please enter label for button.', 'qibla-listings'),
        'after_input'         => function ($obj) {
            return $obj->getType()->getArg('is_invalid') ? $obj->getInvalidDescription() : '';
        },
        'attrs'               => array(
            'placeholder' => esc_html_x('Get ticket at &pound;29', 'placeholder', 'qibla-listings'),
    ...
    'qibla_listing_form-meta-button_url:url'     => $fieldFactory->base(array(
        ...
        'label'               => esc_html__('Button url', 'qibla-listings'),
        ...
        'attrs'               => array(
            'placeholder' => esc_html_x('http://www.site.com', 'placeholder', 'qibla-listings'),
    ...
    'qibla_listing_form-meta-target_link:checkbox' => $fieldFactory->base(array(
        ...
        'label'           => esc_html__('Button target', 'qibla-listings'),
        'description'     => esc_html__('Make this as internal link (default: external)', 'qibla-listings'),
