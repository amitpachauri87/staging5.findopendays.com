...
return apply_filters('qibla_listings_form_socials_fields', array(
    ...
    'qibla_listing_form-meta-social_facebook:url'    => $fieldFactory->base(array(
        ...
        'label'               => esc_html__('Facebook', 'qibla-listings'),
        'container_class'     => array('dl-field', 'dl-field--url', 'dl-field--in-column'),
        'invalid_description' => esc_html__('Please enter valid url.', 'qibla-listings'),
        'after_input'         => function ($obj) {
            return $obj->getType()->getArg('is_invalid') ? $obj->getInvalidDescription() : '';
        },
        'attrs'               => array(
            'placeholder' => esc_html_x('http://www.facebook.com/YourFBPage', 'placeholder', 'qibla-listings'),
    ...
    'qibla_listing_form-meta-social_twitter:url'     => $fieldFactory->base(array(
        ...
        'label'               => esc_html__('Twitter', 'qibla-listings'),
        'container_class'     => array('dl-field', 'dl-field--url', 'dl-field--in-column'),
        'invalid_description' => esc_html__('Please enter valid url.', 'qibla-listings'),
        'after_input'         => function ($obj) {
            return $obj->getType()->getArg('is_invalid') ? $obj->getInvalidDescription() : '';
        ...
        'attrs'               => array(
            'placeholder' => esc_html_x('http://www.twitter.com/YourProfile', 'placeholder', 'qibla-listings'),
    ...
    'qibla_listing_form-meta-social_instagram:url'   => $fieldFactory->base(array(
        ...
        'label'               => esc_html__('Instagram', 'qibla-listings'),
        'container_class'     => array('dl-field', 'dl-field--url', 'dl-field--in-column'),
        'invalid_description' => esc_html__('Please enter valid url.', 'qibla-listings'),
        'after_input'         => function ($obj) {
            return $obj->getType()->getArg('is_invalid') ? $obj->getInvalidDescription() : '';
        ...
        'attrs'               => array(
            'placeholder' => esc_html_x('http://www.instagram.com/YourProfile', 'placeholder', 'qibla-listings'),
    ...
    'qibla_listing_form-meta-social_linkedin:url'    => $fieldFactory->base(array(
        ...
        'label'               => esc_html__('Linkedin', 'qibla-listings'),
        'container_class'     => array('dl-field', 'dl-field--url', 'dl-field--in-column'),
        'invalid_description' => esc_html__('Please enter valid url.', 'qibla-listings'),
        'after_input'         => function ($obj) {
            return $obj->getType()->getArg('is_invalid') ? $obj->getInvalidDescription() : '';
        ...
        'attrs'               => array(
            'placeholder' => esc_html_x('http://www.linkedin.com/in/YourProfile', 'placeholder', 'qibla-listings'),
    ...
    'qibla_listing_form-meta-social_tripadvisor:url' => $fieldFactory->base(array(
        ...
        'label'               => esc_html__('Trip Advisor', 'qibla-listings'),
        'container_class'     => array('dl-field', 'dl-field--url', 'dl-field--in-column'),
        'invalid_description' => esc_html__('Please enter valid url.', 'qibla-listings'),
        'after_input'         => function ($obj) {
            return $obj->getType()->getArg('is_invalid') ? $obj->getInvalidDescription() : '';
        ...
        'attrs'               => array(
            'placeholder' => esc_html_x('http://www.tripadvisor.com/YourProfile', 'placeholder', 'qibla-listings'),
