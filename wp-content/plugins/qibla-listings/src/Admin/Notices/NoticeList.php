<?php
namespace QiblaListings\Admin\Notices;
...
class NoticeList extends Notice
{
    ...
    public function notice()
    {
        ...
        <div class="<?php echo esc_attr($this->getHtmlClass()) ?>">
            ...
            <?php if ($this->list) : ?>
                <ul class="ql-notices-list">
                    <?php foreach ($this->list as $key => $notice) : ?>
                        <li class="ql-notice ql-notice--<?php echo sanitize_html_class($notice['type']) ?>">
