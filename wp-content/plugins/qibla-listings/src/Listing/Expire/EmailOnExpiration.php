...
namespace QiblaListings\Listing\Expire;
...
class EmailOnExpiration
{
     ...
     * @since  1.0.0
     *
     * @uses   QiblaFramework\Functions\getThemeOption() to retrieve the placeholder message.
     *
    ...
    protected function buildMessage()
    {
        ...
        ), F\getThemeOption('listings', 'expired_listing_email'));
    ...
    public function __construct(\WP_User $recipient, \WP_Post $post)
    {
        ...
        /* Translators: %s is the post title */
            esc_html_x('Listing %s Expired', 'expired_email', 'qibla-listings'),
            $this->sanitizeString($this->post->post_title)
        );
     ...
     * @uses   QiblaFramework\Functions\ksesPost() to sanitize the message content
     *
