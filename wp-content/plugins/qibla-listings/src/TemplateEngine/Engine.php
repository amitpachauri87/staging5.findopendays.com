<?php
namespace QiblaListings\TemplateEngine;
 ...
 *
 * @since      1.0.0
 * @package    QiblaListings\TemplateEngine
...
class Engine
{
    ...
    public function render()
    {
         ...
         * @param string    $name The name of the current template instance.
         */
        $data = apply_filters('qibla_listings_template_engine_data', $this->data, $this->name);
         ...
         * @param \stdClass $data The template data.
         */
        $data = apply_filters("qibla_listings_template_engine_data_{$this->name}", $data);
