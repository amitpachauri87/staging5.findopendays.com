...
namespace QiblaListings\Shortcode;

use QiblaFramework\Functions as F;
use QiblaFramework\Debug;
use QiblaFramework\Exceptions\InvalidPostException;
use QiblaFramework\Shortcode\AbstractShortcode;
use QiblaFramework\Shortcode\ShortcodeVisualComposerInterface;
 ...
 * @author Guido Scialfa <dev@guidoscialfa.com>
 */
class ListingPackage extends AbstractShortcode implements ShortcodeVisualComposerInterface
{
    /**
     * Load View
     *
    ...
    protected function getProductData(\WP_Post $post)
    {
        ...
        $product->priceLabel = esc_html__('Free', 'qibla-listings');
    ...
    public function buildData(array $atts, $content = '')
    {
        ...
        foreach ($posts as $post) :
            ...
            $postArgs->submitLabel      = esc_html_x('Choose this plan', 'listing-package', 'qibla-listings');
    ...
    public function callback($atts = array(), $content = '')
    {
        ...
        try {
            ...
            return $this->loadTemplate('dl_sc_package', $data, '/views/shortcodes/listingPackage.php');
        } catch (\Exception $e) {
