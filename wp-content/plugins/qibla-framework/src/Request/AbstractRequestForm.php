...
namespace QiblaFramework\Request;

use QiblaFramework\Functions as F;
use QiblaFramework\Form\Interfaces\Forms;
use QiblaFramework\Shortcode\Alert;
 ...
 * @since   1.5.0
 * @author  Guido Scialfa <dev@guidoscialfa.com>
 * @package QiblaFramework\Request
 */
abstract class AbstractRequestForm
{
    ...
    {
        // @codingStandardsIgnoreLine
        $action = \QiblaFramework\Functions\filterInput($_POST, static::$actionKey, FILTER_SANITIZE_STRING);
