...
use QiblaFramework\LoaderInterface;
...
class Init
{
     ...
     * @param array           $toRmFilters The list of the actions and filters to remove. Optional.
     */
    public function __construct(LoaderInterface $loader, array $filters, array $toRmFilters = array())
    {
        $this->loader      = $loader;
