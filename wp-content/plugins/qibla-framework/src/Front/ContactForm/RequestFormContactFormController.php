...
namespace QiblaFramework\Front\ContactForm;
...
class RequestFormContactFormController extends AbstractRequestFormController
{
    ...
    public function handle()
    {
        ...
        return $response ? new Response(
            200,
            esc_html__('Thank you the email has been send successfully.', 'qibla-framework')
        ) : new Response(
            500,
            esc_html__('Ops! An error occurred. Try in a few minutes.', 'qibla-framework')
        );
    }
}
