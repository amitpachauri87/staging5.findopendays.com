...
class ListingsLocationsField implements FilterFieldInterface
{
     ...
     * @since 2.0.0
     *
     * @var \QiblaFramework\Form\Interfaces\Fields The field for internal use
     */
    private $field;
    ...
    public function __construct($name, $type)
    {
        ...
        $allOptionsLabel = apply_filters(
            ...
            esc_html__('All Locations', 'qibla-framework')
        );
        ...
        $this->field = $factory->base(array(
            'type'         => $type,
            'name'         => $this->name,
            'label'        => esc_html__('Locations', 'qibla-framework'),
            'exclude_none' => true,
            'value'        => $this->value(),
            'select2'      => true,
            'select2_theme'  => 'qibla-minimal',
