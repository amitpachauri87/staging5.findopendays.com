...
function ksesImage($img)
{
     ...
     */
    $attrs = apply_filters('qibla_fw_kses_image_allowed_attrs', array(
        'img' => array(
            'src'      => true,
            'srcset'   => true,
            'sizes'    => true,
...
function ksesPost($data, array $extraAttrs = array())
{
    ...
    // Owl carousel data.
    $tagsInputIncluded['div']['data-items'] = true;
    $tagsInputIncluded['div']['data-nav'] = true;
    $tagsInputIncluded['div']['data-dots'] = true;
    $tagsInputIncluded['div']['data-margin'] = true;
    $tagsInputIncluded['div']['data-loop'] = true;

    // Extra for ARTICLE.
    if (! isset($tagsInputIncluded['article'])) {
        $tagsInputIncluded['article'] = array();
    }
    $tagsInputIncluded['article']['data-marker'] = true;
