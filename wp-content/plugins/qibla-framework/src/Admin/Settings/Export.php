...
class Export
{
    ...
    public function export()
    {
        ...
        foreach ($settings as $setting) :
            ...
            $className = 'QiblaFramework\\Admin\\Settings\\' . $setting;
            ...
            foreach ($obj->getFields() as $field) {
                ...
                $option = F\getThemeOption($optionName, $opt, true);
        ...
        $fileName = sanitize_key(wp_get_theme()->get('Name')) . 'options_backup.json';
