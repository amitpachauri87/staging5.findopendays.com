...
use QiblaFramework\Admin\Panel\Navigation as AdminNavigation;
use QiblaFramework\Admin\Settings\Panel as AdminSettingsPanel;
use QiblaFramework\Admin\Notice\Notice;
...
class Controller
{
     ...
     */
    private $namespace = 'QiblaFramework\\Admin\\Settings';
    ...
    public function process()
    {
        ...
        try {
                ...
                case 'import-export':
                    ...
                    elseif (F\filterInput($_POST, 'qibla_opt_reset', FILTER_SANITIZE_STRING)) :
                        try {
                            ...
                            $importedMsg = esc_html__('Options have been reset correctly.', 'qibla-framework');
                        } catch (\Exception $e) {
            ...
            // Handle the Css if needed.
            $handlerCssInstance = new HandlerCss();
            // @codingStandardsIgnoreLine
            $handlerCssInstance->handle(strtolower(F\filterInput($_POST, 'options_name', FILTER_SANITIZE_STRING)));
        } catch (\Exception $e) {
            $importedMsg = $e->getMessage();
        }//end try
    ...
    public static function initializeControllerFilterCallback()
    {
        ...
        if (in_array($allowedPage, array('qibla', 'qibla-options'), true)) :
            ...
            $controllerPanel->setPanel(new AdminSettingsPanel(
                new AdminNavigation(
                    admin_url('admin.php?page=qibla-options'),
                    $settingsMenuList,
            ...
            add_action('qibla_fw_admin_settings_page_content', array($controllerPanel, 'render'));
