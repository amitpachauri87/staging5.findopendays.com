...
use QiblaFramework\Form\Abstracts\MediaType;
...
class MediaImage extends MediaType
{
    ...
    public function __construct($args)
    {
        $args = wp_parse_args($args, array(
            'btn' => array(
                'label'            => esc_html__('Add Image', 'qibla-framework'),
                'data_media_title' => esc_html__('Upload Image', 'qibla-framework'),
            ),
        ));
    ...
    public function getHtml()
    {
         ...
         */
        $output = apply_filters('qibla_fw_type_mediaimage_output', $output, $this);
