...
class IconList extends Select
{
    ...
    public function getHtml()
    {
        ...
        $options = sprintf(
            ...
            esc_html__('None', 'qibla-framework')
        );
        ...
        $output      .= '<i class="dltype-icon-list-current' . $iconClasses . '"><span class="fa fa-sort-down"></span></i>';
         ...
         */
        $output = apply_filters('qibla_fw_type_iconlist_output', $output, $this);
