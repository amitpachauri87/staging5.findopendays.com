<?php
namespace QiblaFramework\Form\Handlers;

use QiblaFramework\Exceptions\FileNotExistsException;
use QiblaFramework\Form\MimeType;
use QiblaFramework\Plugin;
use QiblaFramework\Form\Exceptions\ExceptionUpload;

/**
 * File Handler
 *
 * @since      1.0.0
 * @package    QiblaFramework\Form\Fields
