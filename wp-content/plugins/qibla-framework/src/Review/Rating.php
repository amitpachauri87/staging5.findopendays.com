...
class Rating
{
    ...
    public function getRatingData()
    {
        ...
        return (object)array(
            'label' => isset($ratingList[$this->value]) ?
                ...
                esc_html__('Unknown', 'qibla-framework'),
    ...
    {
        return array(
            '1' => esc_html__('Very Poor', 'qibla-framework'),
            '2' => esc_html__('Not Bad', 'qibla-framework'),
            '3' => esc_html__('Average', 'qibla-framework'),
            '4' => esc_html__('Good', 'qibla-framework'),
            '5' => esc_html__('Perfect', 'qibla-framework'),
        );
    }
