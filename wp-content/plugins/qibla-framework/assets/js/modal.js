    ...
    function (_, $, ClassList, DL, dllocalized, dlmodallocalized)
    {
        ...
        DL.Modal = {
            ...
            addCloseBtn: function ()
            {
                ...
                text.innerText = dlmodallocalized.closeBtn;
        ...
        DL.Modal.LoginRegisterForm = {
            ...
            createTogglers: function ()
            {
                ...
                signupLink.innerHTML = dlmodallocalized.signupLabel;
                ...
                if (typeof this.forms[1] !== 'undefined' && 0 < parseInt(dllocalized.usersCanRegister)) {
                    ...
                    signinLink.innerHTML = dlmodallocalized.signinLabel;
                ...
                if (typeof this.forms[2] !== 'undefined' && 0 < parseInt(dllocalized.usersCanRegister)) {
                    ...
                    lostpasswordLink.innerHTML = dlmodallocalized.lostPasswordLabel;
                    // Get Back
                    DL.Utils.Functions.classList(goBack).add(
                        'dllogin-register-form__go-back',
                        'dlmodal-form-toggler'
                    );
                    goBack.innerText = dlmodallocalized.goBackLabel;
                    ...
                    var lostPasswordTarget = this.loginRegisterForm.querySelector('#qibla_login_form-remember');
