    ...
    function (DL)
    {
        ...
        window.addEventListener('load', function ()
        {
            ...
            [].forEach.call(gmapDataRef, function (gmapEl)
            {
                ...
                // Base Forms
                if ('DIV' === gmapPosEl.nodeName || 'DIV' === gmapPosEl.parentElement.nodeName) {
                    gmapPosEl.parentElement.appendChild(gmapWrapper);
                }
                // Table Forms
                if ('TD' === gmapPosEl.nodeName) {
                    gmapPosEl.appendChild(gmapWrapper);
                }
                ...
                if (!latlng || (0 === latlng[0] && 0 === latlng[1])) {
