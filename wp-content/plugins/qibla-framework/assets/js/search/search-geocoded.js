        ...
        DL.Search.Geocoded = {
            ...
            submit: function (evt)
            {
                ...
                var _submit = function ()
                {
                    ...
                    // used for the input.
                    var taxFrag = this.input.getAttribute('data-taxpermalink');
                    var lang    = this.form.getAttribute('data-lang');
                    taxFrag     = taxFrag ? '/' + taxFrag + '/' : '';

                    if (this.input.slug) {
                        // Default action url.
                        var actionUrl = dllocalized.site_url + taxFrag + encodeURI(DL.Utils.String.toSlug(this.input.slug));

                        // Set url based lag format.
                        if (!lang.indexOf('lang')) {
                            actionUrl = dllocalized.site_url + taxFrag + encodeURI(DL.Utils.String.toSlug(this.input.slug)) + '?' + lang;
                        } else {
                            lang = lang ? '/' + lang : '';
                            actionUrl = dllocalized.site_url + lang + taxFrag + encodeURI(DL.Utils.String.toSlug(this.input.slug));
                        }
        ...
        var GooglePredictions = {
            ...
            renderSuggestions: function ()
            {
                ...
                if (!this.suggestionsCache) {
                    ...
                    {
                        itemsMarkup += '<li class="menu-item" data-slug="' + item.slug +'" data-label="' + item.label +
            ...
            createItems: function ()
            {
                ...
                if (this.predictions.length) {
                    ...
                    {
                        this.items += '<li class="menu-item" data-slug="' + prediction.description +'" data-label="' + prediction.description +
             ...
             */
            setValue: function (value, slug, type)
            {
                if (value) {
            ...
            setValueByEvent: function (item, evt)
            {
                ...
                this.setValue(
                    ...
                    evt.target.parentNode.getAttribute('data-slug'),
            ...
            navigateThroughItems: function (keyCode)
            {
                ...
                if (!currItem) {
                    ...
                    this.setValue(
                        ...
                        searchNav.firstElementChild.getAttribute('data-slug'),
                ...
                switch (keyCode) {
                    ...
                    case 40:
                        ...
                        this.setValue(
                            ...
                            nextCurrentItem.getAttribute('data-slug'),
