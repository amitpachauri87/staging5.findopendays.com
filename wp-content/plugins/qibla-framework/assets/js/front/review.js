    ...
    DL.Review = {
        ...
        ReplyForm: {
            ...
            setReplyLabels: function (form, container)
            {
                ...
                titleEl.innerHTML = dlreview.formLabels.replyTitle.replace(
                    '%s',
                ...
                commentFormCommentEl.innerText = dlreview.formLabels.textAreaLabel;

                var submitEl = form.querySelector('input[type="submit"]');
                submitEl.setAttribute('data-oldtext', submitEl.value);
                submitEl.value = dlreview.formLabels.submitLabel;
            },
