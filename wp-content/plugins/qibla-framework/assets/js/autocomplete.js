        ...
        DL.Autocomplete = {
            ...
            onSelect: function (suggestion)
            {
                if (typeof suggestion.data !== "undefined") {
                    ...
                    var taxonomy = suggestion.data.taxonomy;
                    if (!taxonomy) {
                    ...
                    if (!form.querySelector('#' + 'qibla_' + taxonomy + '_filter')) {
                        input = document.createElement('input');
                        input.setAttribute('name', 'qibla_' + taxonomy + '_filter');
                        input.setAttribute('id', 'qibla_' + taxonomy + '_filter');
                        input.setAttribute('type', 'hidden');
                    ...
                    form.querySelector('#qibla_' + taxonomy + '_filter').value = suggestion.filterValue;
                }
            },
            ...
            {
                var pattern, suggestionText = suggestion.label;
