...
return apply_filters('qibla_opt_inc_import_export_fields', array(
    ...
    'qibla_opt_export:submit' => $fieldFactory->table(array(
        ...
        'label' => esc_html_x('Export Theme Options', 'settings', 'qibla-framework'),
        'value' => esc_html_x('Export', 'settings', 'qibla-framework'),
        'attrs' => array(
            'class' => array(
                'button',
                'button-primary',
    ...
    'qibla_opt_import:file'   => $fieldFactory->table(array(
        ...
        'use_btn'           => true,
        'file_submit_label' => esc_html_x('Import', 'settins', 'qibla-framework'),
        'label'             => esc_html_x('Import Theme Options', 'settings', 'qibla-framework'),
        'description'       => esc_html_x('Import data retrieved by a previous backup.', 'settings', 'qibla-framework'),
        'value'             => esc_html_x('Import', 'settings', 'qibla-framework'),
    ...
    'qibla_opt_reset:submit'  => $fieldFactory->table(array(
        ...
        'id'          => 'qibla_opt_reset',
        'label'       => esc_html_x('Reset Theme Options', 'settings', 'qibla-framework'),
        'description' => esc_html_x(
            'This will reset all of the settings to their default values.',
            'settings',
            'qibla-framework'
        ),
        'value'       => esc_html_x('Reset', 'settings', 'qibla-framework'),
        'attrs'       => array(
            'class' => array(
                'button',
                'button-secondary',
