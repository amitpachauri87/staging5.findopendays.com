...
// Retrieved color.
$color = F\getTermMeta('_qibla_tb_terms_color', self::$currTerm->term_id) ?: F\getThemeOption('colors', 'main');
/**
...
return apply_filters('qibla_tb_inc_terms_color_fields', array(
    ...
    'qibla_tb_terms_color:color_picker' => $fieldFactory->termbox(array(
        ...
        'label'       => esc_html__('Term Color', 'qibla-framework'),
        'description' => esc_html__('Select your color.', 'qibla-framework'),
