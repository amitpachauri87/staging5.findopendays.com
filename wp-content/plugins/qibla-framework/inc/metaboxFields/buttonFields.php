...
return array(
    ...
    'qibla_mb_button_url:text'  => $fieldFactory->base(array(
        ...
        'label'       => esc_html__('Button url', 'qibla-framework'),
        'description' => esc_html__('Add the url for the button', 'qibla-framework'),
    )),
    ...
    'qibla_mb_button_text:text' => $fieldFactory->base(array(
        ...
        'label'       => esc_html__('Button text', 'qibla-framework'),
        'description' => esc_html__('Add the text of the button', 'qibla-framework'),
    )),
    ...
    'qibla_mb_target_link:checkbox' => $fieldFactory->base(array(
        ...
        'label'       => esc_html__('Button target', 'qibla-framework'),
        'description' => esc_html__('Make this as internal link (default: external)', 'qibla-framework'),
    )),
);
