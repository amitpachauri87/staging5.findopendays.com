...
use \QiblaFramework\Review\RatingCommentMeta;
use \QiblaFramework\Review\Rating;
...
return apply_filters('qibla_mb_inc_comment_additional_fields', array(
    'qibla_mb_comment_rating:select' => $fieldFactory->base(array(
        ...
        'exclude_none' => true,
        'description'  => esc_html__('Set the number of the rating.', 'qibla-framework'),
    ...
    'qibla_mb_comment_title:text'    => $fieldFactory->base(array(
        ...
        'label'        => esc_html__('Review Title', 'qibla-framework'),
        'exclude_none' => true,
        'description'  => esc_html__('Type the title for the review.', 'qibla-framework'),
        'display'      => array($this, 'displayField'),
        'attrs'        => array(
            'class'    => 'widefat',
