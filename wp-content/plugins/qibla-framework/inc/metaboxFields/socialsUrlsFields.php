...
return apply_filters('qibla_mb_inc_social_fields', array(
    ...
    'qibla_mb_social_facebook:text'  => $fieldFactory->base(array(
        ...
        'label'       => esc_html__('Facebook', 'qibla-framework'),
        'description' => esc_html__('Your Facebook profile page url', 'qibla-framework'),
    ...
    'qibla_mb_social_twitter:text'   => $fieldFactory->base(array(
        ...
        'label'       => esc_html__('Twitter', 'qibla-framework'),
        'description' => esc_html__('Your Twitter profile url', 'qibla-framework'),
        'display'     => array($this, 'displayField'),
    )),
    ...
    'qibla_mb_social_instagram:text' => $fieldFactory->base(array(
        ...
        'label'       => esc_html__('Instagram', 'qibla-framework'),
        'description' => esc_html__('Your Instagram profile url', 'qibla-framework'),
        'display'     => array($this, 'displayField'),
    )),
    ...
    'qibla_mb_social_linkedin:text'  => $fieldFactory->base(array(
        ...
        'label'       => esc_html__('Linkedin', 'qibla-framework'),
        'description' => esc_html__('Your Linkedin profile page url', 'qibla-framework'),
        'display'     => array($this, 'displayField'),
    )),
    ...
    'qibla_mb_social_tripadvisor:text'  => $fieldFactory->base(array(
        ...
        'label'       => esc_html__('Trip Advisor', 'qibla-framework'),
        'description' => esc_html__('Your tripadvisor profile page url', 'qibla-framework'),
        'display'     => array($this, 'displayField'),
    )),
));
