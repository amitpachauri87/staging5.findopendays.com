    ...
    <div <?php F\scopeClass('actions') ?>>
        <ul class="dlactions-lists">
            ...
            <span <?php F\scopeClass('wishlist-adder-wrapper') ?>>
                <a data-post-id="<?php echo intval($data->shareAndWish['wish_list']->post->ID); ?>"
                   href="<?php echo esc_attr($data->shareAndWish['wish_list']->queryArgs) ?>"
                   class="<?php echo esc_attr(F\sanitizeHtmlClass($data->shareAndWish['wish_list']->class)) ?>">
                <?php echo esc_html($data->shareAndWish['wish_label']) ?>
                </a>
            </span>
            </li>
        </ul>
