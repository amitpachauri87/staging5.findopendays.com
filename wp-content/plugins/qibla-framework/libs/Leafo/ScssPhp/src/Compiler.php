...
class Compiler
{
    ...
    static public $emptyList = array(Type::T_LIST, '',);
    static public $emptyMap = array(Type::T_MAP, array(),);
    static public $emptyString = array(Type::T_STRING, '"',);
    ...
    public function addParsedFile($path)
    {
        if (isset($path) && file_exists($path)) {
            $this->parsedFilesarray[realpath($path)] = filemtime($path);
        }
    }
    ...
    public function compileValue($value)
    {
        ...
        switch ($type) {
            ...
            case Type::T_INTERPOLATE:
                ...
                switch ($reduced[0]) {
                    // This fix https://github.com/leafo/scssphp/issues/471 Not implemented yet.
                    case Type::T_LIST:
    ...
    protected function mergeDirectRelationships($selectors1, $selectors2)
    {
        ...
        do {
            ...
            $lastSelector1 = array_pop($selectors1);
            $lastSelector2 = array_pop($selectors2);
            array_unshift($merged, array($lastSelector1[0] . $lastSelector2[0]));
