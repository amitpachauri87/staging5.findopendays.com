...
try {
    ...
    $productsList = array_merge(array('none' => esc_html__('Free Listing', 'qibla-events')), $productsList);
...
return apply_filters('qibla_mb_inc_listings_package_product', array(
    ...
    'qibla_mb_listings_products:select'           => $fieldFactory->base(array(
        ...
        'label'       => esc_html__('Related Product', 'qibla-events'),
        'select2'     => true,
        'description' => sprintf(
        /* Translate % is the link of the new product page */
            ...
            esc_html__('create a new one', 'qibla-events') . '</a>'
        ),
