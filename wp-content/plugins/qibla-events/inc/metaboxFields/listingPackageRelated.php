...
return apply_filters('qibla_mb_inc_listings_package_related', array(
    ...
    'qibla_mb_listing_package_related:select' => $fieldFactory->base(array(
        ...
        'label'       => esc_html__('Package Post', 'qibla-events'),
        'select2'     => true,
        'description' => esc_html__('Select what package must be related with this listing.', 'qibla-events'),
        'options'     => array_merge(
            array('none' => esc_html__('None', 'qibla-events')),
            Fw\getPostList('event_package')
        ),
