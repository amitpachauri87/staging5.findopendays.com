...
return array(
    'name'        => esc_html_x('Qibla Events Packages Table', 'shortcode-vc', 'qibla-events'),
    'base'        => $this->tag,
    'category'    => esc_html_x('Qibla', 'shortcode-vc', 'qibla-events'),
    'description' => esc_html_x('Events Packages Table', 'shortcode-vc', 'qibla-events'),
    'icon'        => \QiblaFramework\Plugin::getPluginDirUrl('/assets/imgs/vc-sc-icon.png'),
    'save_always' => true,
    'params'      => array(
        array(
            'heading'    => esc_html_x('Select Packages', 'shortcode-vc', 'qibla-events'),
            'type'       => 'qibla_select2',
            'param_name' => 'posts',
            'std'        => '',
            'value'      => \QiblaFramework\Functions\getPostList('event_package', array('post_title', 'post_name')),
            'attrs'      => array(
                'multiple' => 'multiple',
            ),
        ),
