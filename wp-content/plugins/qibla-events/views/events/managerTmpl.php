...
$headings = array(
    'listing' => esc_html_x('Listing', 'account-posts-manager', 'qibla-events'),
    'status'  => esc_html_x('Status', 'account-posts-manager', 'qibla-events'),
    'actions' => esc_html_x('Actions', 'account-posts-manager', 'qibla-events'),
);
...
if ($data->posts) : ?>
            ...
            <tr class="<?php echo Fw\sanitizeHtmlClass($postContainerClass) ?>">
                ...
                <td <?php Fw\scopeClass('manager-posts-post', 'info') ?>>
                    ...
                    <div <?php Fw\scopeClass('manager-posts-post', 'title') ?>>
                        ...
                        <span>
                            <?php printf(
                                esc_html_x('Expiry date: %s', 'manager-posts', 'qibla-events'),
    ...
    <div <?php Fw\scopeClass('manager-posts', '', 'no-listings') ?>>
        <h3 <?php Fw\scopeClass('manager-posts', 'title') ?>>
            <?php echo esc_html_x('There are no listings right now.', 'manager-posts', 'qibla-events') ?>
        </h3>
    </div>
    <?php
endif;
