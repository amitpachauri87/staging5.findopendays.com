 ...
 * @author alfiopiccione <alfio.piccione@gmail.com>
 */
class Terms extends \QiblaFramework\Shortcode\Terms
{
    /**
     * @inheritDoc
     */
    ...
    public function visualComposerMap()
    {
        ...
        $fields['name']        = esc_html_x('Qibla Event Categories Grid', 'shortcode-vc', 'qibla-events');
        $fields['base']        = $this->tag;
        $fields['category']    = esc_html_x('Qibla', 'shortcode-vc', 'qibla-events');
        $fields['description'] = esc_html_x('Event Categories', 'shortcode-vc', 'qibla-events');

        $fields['params'][0]['value'] = 'event_categories';
