 ...
 * @author alfiopiccione <alfio.piccione@gmail.com>
 */
class Events extends AbstractShortcode implements \QiblaFramework\Shortcode\ShortcodeVisualComposerInterface
{
    /**
    ...
    public function buildData(array $atts, $content = '')
    {
        ...
        foreach ($posts as $post) :
            ...
            // Get Date end.
            $dateEnd = \QiblaFramework\Functions\getPostMeta('_qibla_mb_event_dates_multidatespicker_end', '', $post->ID);
            ...
            $postArgs->buttonMeta = array(
                'url'       => \QiblaFramework\Functions\getPostMeta('_qibla_mb_button_url'),
                'text'      => \QiblaFramework\Functions\getPostMeta('_qibla_mb_button_text'),
                'target'    => \QiblaFramework\Functions\getPostMeta('_qibla_mb_target_link'),
    ...
    {
        return include Plugin::getPluginDirPath('/inc/vcMapping/events.php');
    }
}
