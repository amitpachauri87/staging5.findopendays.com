...
class Sidebar
{
     ...
     *
     * @param string $position 'none' or the passed value if the post type is not event_package and not in singular
     *                         event_package.
     *
    ...
    {
        if (is_singular('event_package') && 'event_package' === get_post_type()) {
            $position = 'none';
        }
