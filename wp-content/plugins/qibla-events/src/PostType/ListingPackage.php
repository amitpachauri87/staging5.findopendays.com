 ...
 * @author Guido Scialfa <dev@guidoscialfa.com>
 */
class ListingPackage extends PostType\AbstractPostType
{
    /**
     * Construct
     *
    ...
    public function __construct()
    {
        parent::__construct(
            'event_package',
            esc_html__('Event Package', 'qibla-events'),
            esc_html__('Packages', 'qibla-events'),
            array(
