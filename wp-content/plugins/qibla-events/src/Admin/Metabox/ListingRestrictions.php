...
class ListingRestrictions extends AbstractMetaboxFieldset
{
    ...
    public function __construct(array $args = array())
    {
        parent::__construct(wp_parse_args($args, array(
            'id'       => 'event_package',
            'title'    => esc_html__('Listing Restrictions', 'qibla-events'),
        ...
        parent::setFieldsets(array(
            ...
            new BaseFieldset(
                ...
                array(
                    ...
                    'legend'          => esc_html__('Base Restrictions', 'qibla-events'),
            ...
            new BaseFieldset(
                ...
                array(
                    ...
                    'legend'          => esc_html__('Additional Info Restrictions', 'qibla-events'),
                    'container_class' => array('dl-metabox-fieldset'),
                    'icon_class'      => 'la la-unlock-alt',
                )
            ),
            ...
            new BaseFieldset(
                ...
                array(
                    ...
                    'legend'          => esc_html__('Socials Restrictions', 'qibla-events'),
                    'container_class' => array('dl-metabox-fieldset'),
                    'icon_class'      => 'la la-unlock-alt',
                )
            ),
            ...
            new BaseFieldset(
                ...
                array(
                    ...
                    'legend'          => esc_html__('Media Restrictions', 'qibla-events'),
                    'container_class' => array('dl-metabox-fieldset'),
                    'icon_class'      => 'la la-unlock-alt',
                )
            ),
