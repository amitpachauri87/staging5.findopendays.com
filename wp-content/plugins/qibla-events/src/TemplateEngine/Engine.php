...
class Engine
{
    ...
    public function render()
    {
        ...
        if (! $this->templatePath) {
            throw new \Exception('AppMapEv Template Engine, wrong path format');
        }
         ...
         * @param string    $name The name of the current template instance.
         */
        $data = apply_filters('appmap_ev_fw_template_engine_data', $this->data, $this->name);
         ...
         * @param \stdClass $data The template data.
         */
        $data = apply_filters("appmap_ev_fw_template_engine_data_{$this->name}", $data);
         ...
         * @param \stdClass                             $data         The template data.
         * @param \AppMapEvents\TemplateEngine\Engine $this         The instance of the class.
         */
        $viewPath = apply_filters('appmap_ev_fw_template_path', $viewPath, $data, $this);
