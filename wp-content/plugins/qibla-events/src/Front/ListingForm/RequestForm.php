...
class RequestForm extends AbstractRequestForm
{
    ...
    public static function handleRequestFilter()
    {
        ...
        if (Ffw\isAjaxRequest() || ! is_singular('event_package')) {
            return;
        }

        // @codingStandardsIgnoreStart
        $packagePost  = get_post(Ffw\filterInput($_GET, 'package_post', FILTER_SANITIZE_NUMBER_INT) ?: 0);
        $postIDToEdit = Ffw\filterInput($_GET, 'postid', FILTER_SANITIZE_NUMBER_INT) ?: 0;
        ...
        // @codingStandardsIgnoreStart
        // Default to Create.
        $action = Ffw\filterInput($_GET, 'dlaction', FILTER_SANITIZE_STRING) ?: 'create';
        // @codingStandardsIgnoreEnd
