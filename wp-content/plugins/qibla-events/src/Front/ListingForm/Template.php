...
class Template
{
     ...
     */
    protected static $templatePath = '/views/events/eventFormPackage.php';
    ...
    public function setTemplate()
    {
        ...
        if (is_singular('event_package')) :
            // Set the content for the page.
            // This is a space to able to pass the condition of the theme.
            $post->post_content = ' ';

            // Add the title filter.
            add_filter('the_title', 'AppMapEvents\\Front\\ListingForm\\Template::titleFilter', 0);
            // Add the content filter.
            add_filter('the_content', 'AppMapEvents\\Front\\ListingForm\\Template::templateContentFilter', 0);
    ...
    public static function titleFilter($title)
    {
        if (in_the_loop() && is_main_query()) {
            $title = esc_html__('Add your Open Day', 'qibla-events') . ' - ' . $title;
            // Remove after done.
            remove_filter('the_title', 'AppMapEvents\\Front\\ListingForm\\Template::titleFilter', 0);
        }
    ...
    public static function templateContentFilter()
    {
        ...
        if (in_the_loop() && is_main_query()) :
            ...
            remove_filter('the_content', 'AppMapEvents\\Front\\ListingForm\\Template::templateContentFilter', 0);
