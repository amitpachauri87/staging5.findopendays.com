...
use AppMapEvents\Crud\EventCreate;
...
use AppMapEvents\Crud\EventUpdate;
            ...
            case 'edit':
                try {
                    ...
                    if (! empty($this->data)) :
                        ...
                        switch ($this->action) :
                            case 'create':
                                ...
                                $data['post_status'] = EventCreate::DEFAULT_POST_STATUS;
                                // Get the instance.
                                $createInstance = new EventCreate(wp_get_current_user(), $data['post_title'], $data);
                                ...
                                if (! $createInstance->postExists()) {
                                    ...
                                    $response = new Response(
                                        201,
                                        esc_html__('Post has been created successfully.', 'qibla-events'),
                                        array(
                                            'action' => 'create',
                                            'postID' => $response,
                                        )
                                    ...
                                    /* Translators: %s is the name of the post */
                                        esc_html__('Post named %s exists.', 'qibla-events'),
                                        $data['post_title']
                                    ));
                                }
                                break;
                            ...
                            case 'edit':
                                ...
                                $updatePost = new EventUpdate(wp_get_current_user(), $post, $data);
                                $updatePost->updateMetaHidden($post, $data);
                                ...
                                $response = new Response(
                                    ...
                                    /* Translators: The %s is the post link. */
                                        esc_html__('Post has been updated successfully. View %s ', 'qibla-events'),
                    ...
                    /* Translators: %s is the dynamic message based on Exception thrown */
                        esc_html__('Error during create or update post. %s', 'qibla-events'),
                        $e->getMessage()
                    ));
                }//end try
                break;
