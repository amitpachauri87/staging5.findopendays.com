...
;(
    function (window, _, $, evlocalized) {
        ...
        function createCalendar(elem)
        {
            ...
            // Set form action.
            elem.form.setAttribute('action', evlocalized.site_url + '/' + evlocalized.events_permalink + '/');
            ...
            $(elem).datepicker({
                ...
                if (this.value) {
                    elem.form.setAttribute('action', evlocalized.site_url + '/' + evlocalized.dates_permalink + '/' + this.value + '/');
                } else {
                    elem.form.setAttribute('action', evlocalized.site_url + '/' + evlocalized.events_permalink + '/');
                }
            });
    ...
    }(window, _, jQuery, window.evlocalized)
);
