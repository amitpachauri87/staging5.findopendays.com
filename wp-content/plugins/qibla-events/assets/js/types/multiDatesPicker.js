 ...
 */
;(
    function (_, $, dllocalized, evlocalized) {
        "use strict";
            ...
            _.forEach(inputs, function (input) {
                ...
                if (null !== dateToday) {
                    $(inputWrapper).datepicker({
                        ...
                        defaultDate: evlocalized.event_saved_default_date,
                        changeMonth: evlocalized.event_date_month_year,
                        changeYear: evlocalized.event_date_month_year,
                        numberOfMonths: 1,
    ...
    }(window._, window.jQuery, window.dllocalized, window.evlocalized)
);