<?php
namespace QiblaImporter\TemplateEngine;
...
class Engine
{
    ...
    public function render()
    {
         ...
         * @param string    $name The name of the current template instance.
         */
        $data = apply_filters('qibla_importer_template_engine_data', $this->data, $this->name);
         ...
         * @param \stdClass $data The template data.
         */
        $data = apply_filters("qibla_importer_template_engine_data_{$this->name}", $this->data);
        ...
        if (! file_exists($viewPath)) {
            $viewPath = F\sanitizePath(Plugin::getPluginDirPath($this->templatePath));
        }
