...
// Sidebar ID.
$sidebar = 'qibla-sidebar-page';

if ('yes' === apply_filters('qibla_show_sidebar', 'yes')) : ?>
    <div <?php F\scopeID('sidebar-page') ?> <?php F\sidebarClass('sidebar', '', 'page') ?>>
        <?php
        /**
         * Before Page Sidebar
         *
         * @since 1.0.0
         */
        do_action('qibla_before_page_sidebar');
        ...
        if (is_active_sidebar($sidebar)) :
             ...
             */
            do_action('qibla_page_sidebar_content', $sidebar);
        endif; ?>
    </div>
<?php endif;
