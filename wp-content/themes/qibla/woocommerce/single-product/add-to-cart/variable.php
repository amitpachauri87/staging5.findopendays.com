    ...
    <form class="variations_form cart" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data'
        ...
        <?php if (empty($available_variations) && false !== $available_variations) : ?>
            <p class="stock out-of-stock">
                <?php _e('This product is currently out of stock and unavailable.', 'qibla'); ?>
            </p>
        <?php else : ?>
            <div class="variations">
                <?php foreach ($attributes as $attribute_name => $options) : ?>
                    <div>
                        <label for="<?php echo sanitize_title($attribute_name); ?>" class="label">
                            <?php echo sanitize_text_field(wc_attribute_label($attribute_name)); ?>
                        </label>
                        <div class="value">
                            <?php
                            ...
                            echo end($attribute_keys) === $attribute_name ?
                                wp_kses_post(apply_filters(
                                    ...
                                    '<a class="reset_variations" href="#">' . esc_html__('Clear', 'qibla') . '</a>'
                                )) : '';
                            ?>
                        </div>
                    </div>
