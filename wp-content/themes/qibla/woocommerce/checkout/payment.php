        ...
        <div class="form-row place-order">
            <noscript>
                ...
                <button type="submit"
                        ...
                        value="<?php esc_attr_e('Update totals', 'qibla'); ?>">
                    <?php esc_attr_e('Update totals', 'qibla'); ?>
                </button>
            </noscript>
            ...
            echo apply_filters(
                ...
                sprintf(
                    '<button type="submit" class="button alt" name="woocommerce_checkout_place_order" id="place_order" value="%1$s" data-value="%2$s">%3$s</button>',
